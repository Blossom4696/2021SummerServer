...
func InitRouter() *gin.Engine {
	logfile, err := os.Create("./logs/gin_https.log")
	if err != nil {
	...
	v1.PUT("/update_exercise", Controllers.ExerciseUpdate)
	...
	v2.PUT("/update_password", Controllers.StudentPasswordUpdateFromStudent)
	...
	v5.PUT("/update_password", Controllers.TeacherPasswordUpdateFromTeacher)
	...
	v5.POST("/update_ask_question", Controllers.AskQuestionUpdateFromTeacher)
	...
	v7.GET("/get_campus_list", Controllers.CampusQuery)
	v7.POST("/register_student", Controllers.StudentRegister)
	...
	v8.PUT("/update_wrong_problem", Controllers.WrongProblemUpdate)
	...
	vadmin.DELETE("/delete_student/:id", Controllers.StudentDeleteFromAdmin)
	...
	vadmin.DELETE("/delete_teacher/:id", Controllers.TeacherDeleteFromAdmin)
	...
	vadmin.GET("/get_order_teacher_list", Controllers.OrderTeacherListQueryFromAdmin)
	vadmin.GET("/get_order_teacher", Controllers.OrderTeacherQueryFromAdmin)
	vadmin.GET("/get_admin_list", Controllers.AdminListQueryFromAdmin)
	vadmin.GET("/get_admin", Controllers.AdminQueryFromAdmin)
	vadmin.POST("/insert_admin", Controllers.AdminInsertFromAdmin)
	vadmin.PUT("/update_admin", Controllers.AdminUpdateFromAdmin)
